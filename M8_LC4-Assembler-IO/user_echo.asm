...
BEGIN_LOOP 
    TRAP x00         ; read character from keyboard into R0 using TRAP_GETC
    CMPI R0, #10     ; sets  NZP 
    BRz END_LOOP     ; tests NZP (#10 is ASCII equivalent for <ENTER>)
                                      
    TRAP x01         ; write character from R0 to ASCII display using TRAP_PUTC	
    BRnzp BEGIN_LOOP ; repeat loop...
END_LOOP
END
